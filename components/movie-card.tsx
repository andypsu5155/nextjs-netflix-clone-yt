...
export default function MovieCard({movieId, overview, title, watchListId, watchList, youtubeUrl, age, time, year }: iAppProps) {
  ...
  return (
    <>
        ...
        <PlayVideoModal youtubeUrl={youtubeUrl} key={movieId} title={title} overview={overview} changeState={setOpen} state={open} age={age} duration={time} release={year} />
    </>
  )
}
